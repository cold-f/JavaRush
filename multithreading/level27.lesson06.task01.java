...
****
Да, такое решение принял валидатор. Но оно не совсем корректное. А что, если 2 хеша окажутся одинаковыми? 
В таком случае надо ввести 3 объект для синхрониазции. Например добавить поле
private static final Object tieLock = new Object();
И написать 3 вариант захвата монитора:
